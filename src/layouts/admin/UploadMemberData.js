...
function UploadMemberData(props) {
      ...
      <div className="row">
        ...
        >
          <div className="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 className="h3 mb-0 text-gray-800">Upload / Import Data </h1>
            <Link
              to={`/admin/upload-account-list`}
...
export default UploadMemberData;
